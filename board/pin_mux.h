 ...
 */
#define PIO1_3_MODE_PULL_DOWN 0x01u

/*! @name PIO1_1 (number 59), SPI
  @{ */
#define SPI_LED_SSEL_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define SPI_LED_SSEL_PIN 1U                   /*!<@brief PORT pin number */
#define SPI_LED_SSEL_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                              /* @} */

/*! @name PIO1_2 (number 61), SPI
  @{ */
#define SPI_LED_SCK_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define SPI_LED_SCK_PIN 2U                   /*!<@brief PORT pin number */
#define SPI_LED_SCK_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                             /* @} */

/*! @name PIO1_3 (number 62), SPI
  @{ */
#define SPI_LED_MISO_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define SPI_LED_MISO_PIN 3U                   /*!<@brief PORT pin number */
#define SPI_LED_MISO_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                              /* @} */

/*! @name PIO0_26 (number 60), SPI
  @{ */
#define SPI_LED_MOSI_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define SPI_LED_MOSI_PIN 26U                   /*!<@brief PORT pin number */
#define SPI_LED_MOSI_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                               /* @} */
